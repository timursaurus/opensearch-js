...
export class Helpers {
   ...
   */
  async search<TDocument = unknown, TRequestBody extends RequestBody = Record<string, any>>(
    params: Search<TRequestBody>,
    options?: TransportRequestOptions
  ): Promise<TDocument[]> {
  ...
  async *scrollDocuments<
    TDocument = unknown,
    TRequestBody extends RequestBody = Record<string, any>
  >(params: Search<TRequestBody>, options?: TransportRequestOptions) {
    appendFilterPath('hits.hits._source', params, true);
