...
// Extend API
export interface ClientExtendsCallbackOptions {
...
export interface OpenSearchDashboardsClient {
  ...
  cat: {
    ...
    cluster_manager<TContext = unknown>(
      params?: T.CatClusterManagerRequest,
      options?: TransportRequestOptions
    ): TransportRequestPromise<ApiResponse<T.CatClusterManagerResponse, TContext>>;
