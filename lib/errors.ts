...
export class TimeoutError<TResponse, TContext> extends OpenSearchClientError {
  name: string;
  message: string;
  meta: ApiResponse<TResponse, TContext>;
...
export class NotCompatibleError<TResponse, TContext> extends OpenSearchClientError {
  meta: ApiResponse<TResponse, TContext>;
